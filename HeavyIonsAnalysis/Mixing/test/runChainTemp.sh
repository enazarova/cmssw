...
cmsDriver.py step3  --conditions auto:run2_mc_HIon --scenario HeavyIons -n 20 --eventcontent RECODEBUG -s RAW2DIGI,L1Reco,RECO --datatier GEN-SIM-RECO --pileup HiMix --pileup_input das:/RelValQCD_Pt_80_120_13/CMSSW_7_2_0_pre7-PRE_LS172_V11-v1/GEN-SIM --filein "file:step2_DIGI_L1_DIGI2RAW_HLT_RAW2DIGI_L1Reco_PU.root"
